# bubble-tree
<img src="img/nick.gif" alt="bubble-tree demo">

Quickly and easily turn a few simple nested `<ul>...</ul>` lists into an attractive, impactful, easily navigable site! Use **bubble-tree** for social media link aggregation landing pages, personal CVs, and offline presentations.

[Check out the live demo.](https://ryanmead.github.io/bubble-tree/)
## Easy to deploy
If you can code a few nested `<ul>...</ul>` lists, you got this! **bubble-tree** styles every `<li>` tag as a "bubble" (a circle with a semitransparent background) and arranges the bubbles to show the data hierarchy.
...
## Other limitations
For other caveats, along with more detailed instructions, see the [live demo/help page](https://ryanmead.github.io/bubble-tree/).